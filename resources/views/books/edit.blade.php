                    ...
                    <section>
                        ...
                        <form method="POST" action="{{ route('books.update', ['book' => $book->id]) }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-textarea-input id="description" name="description" type="text" rows=6 class="mt-1 block w-full" :value="old('description', $book->description)" required autofocus autocomplete="description" />
